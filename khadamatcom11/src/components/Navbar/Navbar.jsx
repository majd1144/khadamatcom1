...
const Navbar = ({ theme, setTheme }) => {
  ...
  <ul className="dropdown-menu text-dark">
    <li><Link className="dropdown-item text-dark" to="/services-in/5">Teacher</Link></li>
    <li><Link className="dropdown-item text-dark" to="/services-in/4">Wall Painter</Link></li>
    <li><Link className="dropdown-item text-dark" to="/services-in/3">Babysitter</Link></li>
